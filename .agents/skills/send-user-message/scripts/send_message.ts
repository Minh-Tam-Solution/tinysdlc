...
/**
 * send_message.ts — Write a message to the TinySDLC outgoing queue
...
const localTinysdlc = path.join(SCRIPT_DIR, '.tinysdlc');
const TINYSDLC_HOME = fs.existsSync(path.join(localTinysdlc, 'settings.json'))
    ? localTinysdlc
